...
void Table::upperPartTablePrint(vector<int> width) const {
...
void Table::middlePartTablePrint(vector<int> width, bool up) const {
...
void Table::bottomPartTablePrint(vector<int> width) const {
